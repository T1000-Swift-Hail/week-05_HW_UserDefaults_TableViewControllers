...
//  shoppingList
//
//  Created by Huda N S on 26/03/1443 AH.
//
...
class TableViewController: UITableViewController {
    ...
    var shoppingList = ["Appels","Oranges","Mangoes"]
    ...
    override func viewDidLoad() {
        ...
        if let setItems = defaults.object(forKey: "items") as? [String] {
    ...
    @IBAction func add(_ sender: Any) {
        ...
        let add = UIAlertAction(title: "Add", style: .default) { action in
            ...
            self.defaults.set(self.shoppingList, forKey: "items")
            self.tableView.reloadData()
    }
        let cancal = UIAlertAction(title: "cancal", style: .cancel, handler: nil)
